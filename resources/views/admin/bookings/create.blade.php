        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.bookings.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="arena_id" id="arena_id" class="form-control">
                            @foreach ($arenas as $arena)
                                <option {{ $arenaNumber == $arena->number ? 'selected' : null }}
                                    value="{{ $arena->id }}">{{ $arena->number }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="bukti_p" class="form-label">{{ __('Bukti Pembayaran') }}</label>
                        <input class="form-control" type="file" id="bukti_p"
                            name="bukti_p">
                    </div>
                    <div class="form-group">
